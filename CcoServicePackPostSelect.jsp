...
%>
  <script language="javascript"> <!--
    ...
    //........................................................................  
    // DESCRIPTION:
    // Changes the up/over images if the form has not been submitted.
    //........................................................................  
...
%>
  <%
    ...
    //out.println( "spritAccessManager.isAdminION() = " + spritAccessManager.isAdminION());
   if("ION".equalsIgnoreCase(osType)) {
     if (spritAccessManager.isAdminION() ) {
        ...
        out.println( SpritGUI.renderTabContextNav( globals,
    				   ...
    				   (strMode.equals("SPPost")&& isAllowedToPostToCco) ? false : true,
    				   (strMode.equals("Report")) ? false : true,
                    		...
                    		new String [] {
                    		            "CcoPostStatusView.jsp?osTypeURL=ION&mode=View&releaseNumberId=" + releaseNumberId,
                      		            "CcoServicePackPostSelect.jsp?osTypeURL=ION&mode=SPPost&releaseNumberId=" + releaseNumberId,
                      		            "CcoPostStatusView.jsp?osTypeURL=ION&mode=Report&releaseNumberId=" + releaseNumberId,
                      		            "CcoPostRecordsSelect.jsp?osTypeURL=ION&mode=PatchPost&releaseNumberId=" + releaseNumberId}
                    		        ) ) );
       } else {
...
<!--   <br><br><br><center> ----- This Page is Obsoluted - We are cuurently Using Ypublish For ION CCO Posting.This 
JSP is No more Valid - any Question Please Contact kdharmal, or vpalani, or susingh.
      ...
      <td bgcolor="#BBD1ED">
        <table cellspacing="0" cellpadding="3" border="1">
         <tr>
          ...
          <% if ("ION".equalsIgnoreCase(osType)) { %>
             <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CCO Post Selection - Select Patch/Maintenance Packs to Post
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></font></span></td>
          
          <% } else { %>
             <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CCO Post Selection - Select Service Packs  to Post
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></font></span></td>
          <% } /* if ("ION".equalsIgnoreCase(osType)) */ %>
         </tr>
        </table>
 ...
 <input type="hidden" name="patch_type" value="SP" />
 ...
 <center>
   ...
   <td bgcolor="#3D127B">
    ...
    <table cellspacing="0" cellpadding="3" border="1">
     <tr bgcolor="#d9d9d9">
          ...
          <% if ("ION".equalsIgnoreCase(osType)) { %>
          	...
          	<td align="center"><span class="dataTableTitle">Patch/Maintenance Pack Name</font></span></td>          
         	<td align="center"><span class="dataTableTitle">Patch/Maintenance Pack Id</span></td>
          <% } else { //else if ("ION".equalsIgnoreCase(osType))
          %>
          	<td align="center"><span class="dataTableTitle">Service Pack Name</font></span></td>          
          	<td align="center"><span class="dataTableTitle">Service Pack Id</span></td>
          <% } //end if ("ION".equalsIgnoreCase(osType))
          %>
    ...
    <%
        ...
        String ptsURL = SpritInitializeGlobals.getInstance().getEnvProperty(ptsURLKey);         //out.println("ptsURL is " + ptsURL );
   
   while( iter.hasNext() ) {
     ccoInfo = (CcoInfo) iter.next();
     if (ccoInfo.getIsPostedToCco().equals("Y") || ! ccoInfo.getPatchType().equalsIgnoreCase("SP")  ){
       continue;
     }else{
       displayCount++;
     }
    ...
    <tr bgcolor="#ffffff">  
      ...
      <td valign="top" align="left"><span class="dataTableData"><font size="1"><%= ccoInfo.getType()%></font></span></td>
