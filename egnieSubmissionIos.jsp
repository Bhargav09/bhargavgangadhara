...
<script type="text/javascript"
	...
	<script type="text/javascript"
	src="/irt/resources/js/posting/egenieSubmissionIos.js"></script>
<script type="text/javascript"
...
<a href="#" onclick="javascript:viewAll(document.getElementById('releaseNumberId').value);">eGenie Report<b></b></a><b><br>
