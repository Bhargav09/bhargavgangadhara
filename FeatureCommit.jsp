...
<%= SpritGUI.pageHeader( globals,"Feature Commit Result","" ) %>
<%= SpritGUI.pageBanner( globals,"popup","Feature Commit Result" ) %>
...
<html>
<head>
  <title>SPRIT - Feature Commit to Upgrade Planner is Done... </title>
