...
<%
    ...
    final  String THIS_FILE = "[MdfTreePrioritzationjs.jsp] ";
...
<form name="MdfTreeJavaScriptForm" action="MdfTreePrioritizationPost.jsp" method="post">
...
<input type="hidden" name="osTypeId"           value="<%=osTypeId%>">
